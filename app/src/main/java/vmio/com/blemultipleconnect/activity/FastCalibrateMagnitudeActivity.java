...
public class FastCalibrateMagnitudeActivity extends AppCompatActivity implements BleWrapperUiCallbacks {

    String TAG = "FastCalibrateMagnitudeActivity";
    public FastCalibrateMagnitudeActivity mThis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fast_magnitude_calibrate);
...
//        chart.setLayoutParams(params);
    ...
    private void invalidateChart(Point3D magnet) {
        ...
        //saveValue(magnet);
        isCalibrate = magnetCalibrate.addData(magnet, Define.MAGNET_FAST_CALIB_MAXTIME_DATA);
        ...
        new OkHttpService(OkHttpService.Method.GET, this, Define.URL_GET_CALIBRATE, params, false) {
            ...
            public void onResponseApi(Call call, Response response) throws IOException {
                ...
                if (result.equals("Not Found")) {
                    ...
                    calibrationFactor = magnetCalibrate.calibrate(null);
                    magnetCalibrate.saveFactor(mBlueToothSenSor.getDevice().getAddress());
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
