...
public class IPAdapter extends RecyclerView.Adapter<IPAdapter.ViewHolder> {
    ...
    public IPAdapter(Context context, ArrayList<String> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_ip, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            myTextView = (TextView) itemView.findViewById(R.id.txt_ip);
