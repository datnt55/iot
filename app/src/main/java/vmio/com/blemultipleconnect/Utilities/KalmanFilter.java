...
public class KalmanFilter  {
    ...
    final double VeryGoodAccuracy = 4.0;
    final double VeryBadAccuracy = 30.0;
    ...
    public void Process(double lat_measurement, double lng_measurement, double accuracy, long TimeStamp_milliseconds)
    {
        ...
        if (variance < 0 || accuracy < VeryGoodAccuracy)     // [20180225    VMio] High accuracy then keep this point as anchor
        {
        ...
        else
        {
            ...
            double K = (accuracy > VeryBadAccuracy) ? 0.0 : variance / (variance + accuracy * accuracy);
            // apply K
