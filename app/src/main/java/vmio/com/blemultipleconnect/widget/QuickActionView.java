...
public class QuickActionView extends CustomPopupWindow implements OnClickListener, DialogInterface {
	...
	public QuickActionView( View anchor ) {
		...
		txtWarning = (TextView) root.findViewById( R.id.txt_warning);
	}
...
//		createActionList();
		...
		if (!onTop)
			scroller.setBackgroundResource(R.drawable.bg_quick_action);
		else
			scroller.setBackgroundResource(R.drawable.bg_quick_action_down);
