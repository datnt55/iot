    ...
    private final MyLocationListener nmeaListener = new MyLocationListener() {
        ...
        public void onLocationChanged(@NonNull MLocation loc) {
            if(!bluetooth.preferenceEnabled && locationProviderNMEA.nmeaReceived) {
                updateLocation(loc, "LocationProviderNMEA");
            }
        }
        @Override
...
//            }
            ...
            updateLocation(loc, "LocationProviderAndroid");
        }
        ...
        @Override
        public void onLostLocation(String device) {
            updateLocation(null,"LocationProviderAndroid");
        }
    ...
    private final MyLocationListener bluetoothListener = new MyLocationListener() {
        ...
        public void onLocationChanged(@NonNull MLocation loc) {
            if(bluetooth.preferenceEnabled) {
                updateLocation(loc, "LocationServiceBluetooth");
            }
        }
        @Override
        public void onLocationChangedPostExecute(String device) {}
        ...
        @Override
        public void onLostLocation(String device) {
            updateLocation(null,"LocationServiceBluetooth");
        }

        @Override
        public void onReceiveLocation(String device, MLocation location) {
            updateLocation(location, device);
        }
    };
