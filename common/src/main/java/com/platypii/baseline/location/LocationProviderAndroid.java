...
class LocationProviderAndroid extends LocationProvider implements LocationListener, GpsStatus.Listener, LocationProvide.OnUpdateLocation {
...
//            }
//        }
        locationProvide = new LocationProvide((Activity)context, this);
    ...
    public void onLocationChanged(Location loc) {
        ...
        if (Numbers.isReal(loc.getLatitude()) && Numbers.isReal(loc.getLongitude())) {
            ...
            updateLocation(new MLocation(true, // GPS source is Android
                    lastFixMillis, latitude, longitude, altitude_gps, alti.climb, vN, vE,
                    hAcc, pdop, hdop, vdop, satellitesUsed, satellitesInView), providerName());
        }
    }
    @Override
    ...
    public void onUpdate(Location loc) {
        if (Numbers.isReal(loc.getLatitude()) && Numbers.isReal(loc.getLongitude())) {
            ...
            updateLocation(null, providerName());
        }
    }
}
