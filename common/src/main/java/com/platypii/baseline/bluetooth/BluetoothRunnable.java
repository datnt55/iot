...
class BluetoothRunnable implements Runnable {
    ...
    private GPSSensorStateListener listener;

    BluetoothRunnable(BluetoothService bluetooth, @NonNull BluetoothAdapter bluetoothAdapter, GPSSensorStateListener listener) {
